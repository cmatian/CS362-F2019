...
/* Refactored Function Definitions for Assignment 2*/

/* Baron Card Execution */
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        ...
        return playCardMine(choice1, choice2, state, handPos, currentPlayer);
    ...
    case baron:
        /* New Function - Added in Assignment 2 */
        return playCardBaron(card, choice1, state, handPos, currentPlayer);
    ...
    case minion:
        /* New Function - Added in Assignment 2 */
        return playCardMinion(card, choice1, choice2, state, handPos, currentPlayer);
    ...
    case ambassador:
        /* New Function - Added in Assignment 2 */
        return playCardAmbassador(card, choice1, choice2, state, handPos, currentPlayer);
