...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  case mine:
    playCardMine(choice1, choice2, handPos, state, currentPlayer);
  ...
  case baron:
    playCardBaron(choice1, state, currentPlayer);
  ...
  case minion:
    playCardMinion(choice1, choice2, state, currentPlayer, handPos);
  ...
  case ambassador:
    playCardAmbassador(choice1, choice2, handPos, state, currentPlayer);
